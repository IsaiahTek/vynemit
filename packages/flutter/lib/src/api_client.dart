...
class NotificationApiClient {
  ...
  Future<T> _request<T>(
    ...
    final locatedData = config.dataLocator != null ? config.dataLocator!(data) : data;
  ...
  Future<List<Notification>> getNotifications({
    ...
    final dynamic data = await _request('/notifications/${config.userId}$query');
  ...
  Future<int> getUnreadCount() async {
    final dynamic data = await _request('/notifications/${config.userId}/unread-count');
    return data['count'] as int;
  }

  Future<NotificationStats> getStats() async {
    final dynamic data = await _request('/notifications/${config.userId}/stats');
    return NotificationStats.fromJson(data);
  }

  Future<NotificationPreferences> getPreferences() async {
    final dynamic data = await _request('/notifications/${config.userId}/preferences');
    return NotificationPreferences.fromJson(data);
  }

  Future<void> markAsRead(String notificationId) async {
    await _request('/notifications/${config.userId}/$notificationId/read', method: 'PATCH');
  }
  ...
  Future<void> markAsUnread(String notificationId) async {
    await _request('/notifications/${config.userId}/$notificationId/unread', method: 'PATCH');
  }

  Future<void> markAllAsUnread() async {
    await _request('/notifications/${config.userId}/unread-all', method: 'PATCH');
  }

  Future<void> deleteNotification(String notificationId) async {
    await _request('/notifications/${config.userId}/$notificationId', method: 'DELETE');
  }
  ...
  Future<void> updatePreferences(Map<String, dynamic> prefs) async {
    await _request('/notifications/${config.userId}/preferences', method: 'PUT', body: prefs);
  }
